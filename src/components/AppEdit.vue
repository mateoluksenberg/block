      ...
      <b-navbar toggleable="lg" type="dark" variant="dark">
        ...
        <b-collapse id="nav-collapse" is-nav>
          <b-navbar-nav class="ml-auto">
            ...
            <b-nav-item style="color: white;" href="#">List Apartement</b-nav-item>
          </b-navbar-nav>
        </b-collapse>
      ...
      <div class="container py-5">
        <div class="row">
          <div class="col-md-4">
            <div class="card card-body bg-dark rounded-0 mb-4">
              ...
              <input
                ...
                class="form-control bg-dark border-0 rounded-0 text-light my-4"
              ...
              />
              <button class="btn btn-primary" @click="createApartment">
                Create Apartment
              </button>
            </div>
          </div>
          <div class="col-md-8">
            ...
            <ul>
              <li v-for="apt in apartments" :key="apt.id">
                <strong>{{ apt.name }}</strong> - {{ apt.location }} -
                {{ web3.utils.fromWei(apt.price, "ether") }} ETH
              </li>
            </ul>
          </div>
        </div>
